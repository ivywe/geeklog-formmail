// +---------------------------------------------------------------------------+
// | FormMail Static Page for Geeklog 1.8 higher Bootstrap class added, English|
// +---------------------------------------------------------------------------+
// | staticpages_formmail_bootstrap_en.php                                     |
// |                                                                           |
...
$_spreferererrormsg = '<p class="text-danger">Access denied.</p>';
...
array('header'=>'Organization',
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_organization', 'size'=>'40', 'maxlength'=>'60', 'class'=>'form-control ime_on', 'placeholder' => 'Type your organization.' ),
  ),
),
// } table 1 row
// table 1 row {
array('header'=>'Name',
  ...
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_name', 'size'=>'40', 'maxlength'=>'40', 'class'=>'form-control ime_on', 'value'=>$username, 'placeholder' => 'Please type your name.' ),
  ),
),
// } table 1 row
// table 1 row {
array('header'=>'Email',
  ...
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_mail', 'size'=>'40', 'maxlength'=>'240', 'class'=>'form-control ime_off', 'value'=>$user_email,'placeholder' => 'Enter your e-mail address.' ),
array( 'type'=>'text', 'name'=>'q_mail_re', 'size'=>'40', 'maxlength'=>'240', 'class'=>'form-control email ime_off mt10', 'not_confirm'=>'true', 'not_csv'=>'true', 'value'=>$user_email, 'placeholder' => 'Please enter your e-mail address again to confirm.' ),
  ),
),
// } table 1 row
// table 1 row {
...
array('header'=>'Phone',
  ...
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_phone', 'size'=>'20', 'style'=>'width: 20em;', 'maxlength'=>'13', 'class'=>'form-control ime_off', 'placeholder' => 'e.g.&nbsp;+81311112222.' ),
...
array( 'input'=>"<strong><span id='tasp1'></span></strong>" ),
  ),
),
// } table 1 row
),),
...
<p style="margin-top:10px">Some error found. Please check below and correct your input.</p>
<ol>
$errmsg
</ol>
</div>
...
function _fmChkReferer ($pu,$err) {
    ...
    if (!isset($_SERVER['HTTP_REFERER'])) {
        if (!empty($_POST)) { $msg = '<p class="text-danger">REFERER check required. But REFERER is not set on your server. Please contact your server-administrator.</p>'; }
