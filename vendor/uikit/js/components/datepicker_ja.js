        ...
        defaults: {
            ...
            template: function(data, opts) {
                ...
                if (UI.formSelect) {
                    ...
                    years  = '<span class="uk-form-select">'+ data.year + '年<select class="update-picker-year">'+options.join('')+'</select></span>';

                    content += '<div class="uk-datepicker-heading">'+ years + ' ' + months +'</div>';
