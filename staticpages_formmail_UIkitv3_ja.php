...
array('header'=>'お名前（漢字）',
  ...
  'help'=>'全角で名前を入力してください。',
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_name', 'size'=>'40', 'maxlength'=>'40', 'aria-required'=>'true', 'required'=>'', 'class'=>'uk-input ime_on', 'value'=>$username, 'placeholder'=>'全角で入力してください。' ),
  ),
),
// } 1行
// 1行 {
array('header'=>'お名前（カタカナ）',
  ...
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_kana', 'size'=>'40', 'maxlength'=>'40', 'aria-required'=>'true', 'required'=>'', 'class'=>'uk-input ime_on', 'placeholder'=>'全角で入力してください。' ),
  ),
),
// } 1行
// 1行 {
...
array('header'=>'電話番号',
  ...
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_phone', 'size'=>'20', 'maxlength'=>'13', 'aria-required'=>'true', 'required'=>'', 'class'=>'uk-input ime_off' ),
array( 'string'=>'<br'.XHTML.'>' ),
...
array('header'=>'希望日',
  'help'=>'ご連絡希望日を選んでください。',
  'data'=>array(
array( 'type'=>'text', 'name'=>'q_date1', 'size'=>'20', 'data-uk-datepicker'=>"{format:'YYYY.MM.DD'}", 'class'=>'uk-input'  ),
  ),
),
// } 1行
// 1行 {
array('header' => '時間帯',
  'help'=>'ご連絡時間帯を選んでください。',
  'data'=>array(
array( 'type'=>'select', 'name'=>'q_access_time', 'style'=>'width: 15em;', 'options'=>array('selected' => '特に希望なし', 'values' => '特に希望なし,午前,午後   - 夕方まで,夕方以降'), 'class'=>'uk-input'  ),
...
function _fmMkSeni ($items, $action) {
  $buf = '<div class="uk-child-width-1-2@s uk-child-width-1-3@m uk-text-center uk-button-group">'.LB;
